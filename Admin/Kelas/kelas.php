...
$total_result = $conn->query("SELECT COUNT(id) AS id FROM kelas");
$total_row = $total_result->fetch_assoc();
$total_courses = $total_row['id'];
$total_pages = ceil($total_courses / $limit);

// Query untuk mengambil data kursus dari tabel kelas secara descending
$sql = "SELECT * FROM kelas ORDER BY created_at DESC LIMIT $start, $limit";
...
<body>
    ...
    <aside id="sidebar">
        ...
        <!-- Main Content -->
        <div id="main-content">
            <h1 class="title p-1 fw-bolder">Kelas</h1>

            <!-- BUTTON -->
            <div class="mb-3">
                <a href="tambahKelas.php" class="btn btn-success"><i class="fa-solid fa-plus me-2"></i>Tambah Kelas</a>
            </div>
                            ...
                            <?php while ($row = $result->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="editKelas.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-warning btn-sm me-1" title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="hapusKelas.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-danger btn-sm me-1" title="Delete" onclick="return confirm('Are you sure you want to delete this course?');">
    ...
    <script>
        ...
        function viewCourse(courseId) {
            fetch('ambilDetailKelas.php?id=' + courseId)
